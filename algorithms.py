...
class Checksum(Algorithm):
    ...
    def __call__(self) -> bool:
       ...
       # self.make_multiple_of(16)
        ...
        digit_sum_and_overflow_receiveddata = self.sumsubstrings_and_overflow(data_as_arr)
        ...
        while 1 in summed_substrings_receiveddata[1::]:
            summed_substrings_receiveddata = self.sumsubstrings_and_overflow(summed_substrings_receiveddata)

        complement_checksum_and_substrings = self.the_ones_complement(summed_substrings_receiveddata)
